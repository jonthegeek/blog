...
5. Set the `Publish directory` to "public" (without the quotes). This is the directory that blogdown populates with the actual files for your site.
6. Click `Deploy site`.
...
Note: Your blog... doesn't work yet. You need a post before blogdown will believe that you actually have a blog, logically enough.
...
Go back to your Git tab, commit everything, and push back up to your repo. You should now have a blog!
